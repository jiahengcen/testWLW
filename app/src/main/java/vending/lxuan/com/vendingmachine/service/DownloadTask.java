...
public class DownloadTask extends AsyncTask<String, Integer, Integer> {
    ...
    protected Integer doInBackground(String... params) {
        ...
        //下载文件存放的目录
        String directory = new File(APP_VIDEO_DIR).getAbsolutePath();
        ...
        if (contentLength == 0) {
            ...
            SharedPreferences.Editor editor = BaseApplication.sAppContext.getSharedPreferences(VideoHelp.VIDEO_FILE_NAME, Context.MODE_PRIVATE).edit();
            editor.putString(VideoHelp.VIDEO_NAME, fileName);
            editor.apply();
            lock.unlock();
            return TYPE_SUCCESS;
        }
